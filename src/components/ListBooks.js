        ...
        return (
            <div className="list-books">
                ...
                <div className="list-books-content">
                    <div>
                        <Bookshelf title={this.state.current.title} books={this.state.current.books} change={this.changePosition}/>
                        <Bookshelf title={this.state.want.title} books={this.state.want.books} change={this.changePosition}/>
                        <Bookshelf title={this.state.read.title} books={this.state.read.books} change={this.changePosition}/>
                    </div>
                </div>
